export default function Socials() {
  return (
    <fieldset className='border border-white w-10 p-2 rounded mt-auto'>
      <legend className='text-lg px-1'>socials</legend>
      ...
      <ul className='flex flex-col items-center justify-evenly'>
        ...
        <li className='mb-4'>
          <a href='https://dev.to/TakshakRamteke' target='_blank'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 448 512'
              className='w-7 h-7 invert'>
        ...
        <li className='mb-4'>
          <a href='https://linkedin.com/in/TakshakRamteke' target='_blank'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 448 512'
              className='w-7 h-7 invert'>
        ...
        <li className='mb-4'>
          <a href='https://www.instagram.com/takshak_ramteke/' target='_blank'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 448 512'
              className='w-7 h-7 invert'>
