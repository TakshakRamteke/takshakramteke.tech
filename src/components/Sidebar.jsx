...
export default function Sidebar({ title }) {
    ...
    return (
        <nav className="sticky top-0 flex h-11 w-full animate-movedown items-center rounded-sm border-b border-black p-2 font-sans backdrop-blur-md lg:h-screen lg:w-11 lg:flex-col lg:border-b-0 lg:border-l">
            ...
            <div
                className={`grid h-11 place-content-center border-r border-black lg:w-11 lg:place-content-evenly lg:border-b ${title === "Testimonials"
                    ? "lg:h-52"
                    : title === "Blogs"
                        ? "lg:h-40"
                        : "lg:h-40"
            ...
            <div
                className={`ml-auto border-l border-black py-1 pl-2 pt-2 lg:mt-auto lg:border-l-0 lg:border-t lg:pl-0 ${open ? "border-white text-white lg:z-10" : ""
                    }`}
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
